    ...
    <div className="bg-gray-200 m-0 font-sans">
      ...
      <div className="relative p-6">
        <div className="flex flex-col lg:flex-row items-start lg:items-center">
          <img src="/images/1.jpg" className="h-96 w-96 mt-10 lg:mt-0 lg:ml-15" alt="New Balance 574" />
          <div className="lg:ml-10 mt-6 lg:mt-0">
            ...
            <button className="bg-black text-white px-10 py-2 rounded-lg hover:bg-gray-800 active:bg-gray-600 mt-4" onClick={handleAddToCart}>
              {buttonText}
            </button>
          </div>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap justify-between items-center">
          <img src='/images/26.jpg' className='mt-3 ml-3 h-48 w-48 object-cover' alt="Product 1" />
          <img src='/images/10.jpg' className='mt-3 h-48 w-48 object-cover' alt="Product 2" />
          <img src='/images/24.jpg' className='mt-3 h-48 w-48 object-cover mr-3' alt="Product 3" />
        </div>
      </div>
