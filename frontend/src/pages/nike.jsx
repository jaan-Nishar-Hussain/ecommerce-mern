...
import { useCart } from './cartContext';  // Corrected import
...
const Nike = () => {
  ...
  <img src="/images/24.jpg" className="h-120 w-120 mt-10 ml-15" />
  <div className="absolute top-0 left-4 text-left ml-135">
    <p className="mb-2  text-gray-800">Jordan</p>
    <p className="font-bold">AIR JORDAN 1 RETRO HIGH OG 'UNIVERSITY BLUE/UNIVERSITY GOLD-SAIL'
    </p>
    <p className="text-sm text-gray-800">16,995.00</p>
    <p className='text-grey-800'>MRP inclusive of all taxes</p>
    <p className='mr-30 mt-5 text-grey-800'>This iteration of the AJ1 reimagines Mike's first signature model with a fresh mix of colors. 
        Premium materials, soft cushioning and a padded 
        ankle collar offer total support and celebrate the shoe that started it all.</p>
...
<div className='flex justify-between items-center'>
    ...
    <img src='/images/26.jpg ' className='mt-3 h-85 w-95 mr-3'/>
</div>
